...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        val dogHobbiesView = view?.findViewById<TextView>(R.id.dog_hobbies)
    }
    ...
    override fun onBindViewHolder(holder: DogCardAdapter.DogCardViewHolder, position: Int) {
        ...
        holder.imageView?.setImageResource(currentData.imageResourceId)
        holder.dogNameView?.text = currentData.name
        holder.dogAgeView?.text = currentData.age

        val resources = context?.resources
        val hobbies = resources?.getString(R.string.dog_hobbies, currentData.hobbies)

        holder.dogHobbiesView?.text = hobbies
    }
}
